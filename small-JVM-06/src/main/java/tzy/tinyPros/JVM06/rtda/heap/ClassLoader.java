package tzy.tinyPros.JVM06.rtda.heap;
...
import tzy.tinyPros.JVM06.rtda.heap.methodarea.Slots;
    ...
    private void initStaticFinalVar(Class clazz, Field field) {
        ...
        if (rpId > 0) {
            switch (field.descriptor) {
                ...
                case "S":
                case "I":
                    java.lang.Object val0 = rp.constants[rpId];
                    staticVars.setInt(slotId, (Integer) val0);
                    break;
                case "J":
                    java.lang.Object val1 = rp.constants[rpId];
                    staticVars.setLong(slotId, (Long) val1);
                    break;
                case "D":
                    java.lang.Object val2 = rp.constants[rpId];
